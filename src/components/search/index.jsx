...
export const Search = ({ setSearch }) => {
    ...
    const popularTags = ["Men", "Women", "Clothes", "Accessories", "Shoes", "Bags", "Jewelry"];
  ...
  return (
    <div className=" d-flex justify-content-between align-items-center flex-wrap flex-column searchContainer">
